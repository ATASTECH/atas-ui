...
To begin, follow the [installation guide](https:/ui.atastech.com/docs/ui/installation) and set up your project with shadcn and Base UI.

<GithubInfo owner="aeonzz" repo="atas-ui" />
